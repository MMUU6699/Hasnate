  ...
  return (
    <>
      ...
      >
        {ayah && (
          <>
            <div className="p-4 flex justify-between items-center border-b dark:border-gray-700 bg-teal-50 dark:bg-gray-900/50 sticky top-0">
              <h3 id="tafsir-heading" className="text-xl font-bold text-teal-800 dark:text-teal-400">

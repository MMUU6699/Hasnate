...
const Header: React.FC<HeaderProps> = ({ onMenuClick }) => {
  ...
  return (
    <header className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm sticky top-0 z-20 p-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
       <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2">
            <h2 className="text-xl sm:text-2xl font-bold text-teal-700 dark:text-teal-300">{title}</h2>
            {isOnlinePage && (
              <div className="bg-sky-100 text-sky-700 text-xs font-bold px-2.5 py-1 rounded-full dark:bg-sky-900/70 dark:text-sky-300 flex items-center gap-1">

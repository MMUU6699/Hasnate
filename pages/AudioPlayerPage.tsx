...
const AudioPlayerPage: React.FC = () => {
    ...
    const DownloadButton: React.FC<{ qari: Qari; surah: SurahInfo }> = ({ qari, surah }) => {
        ...
        if (qari.apiProvider === 'alquran.cloud') {
            return null;
        }
        ...
        if (isDownloading) {
            return (
                <div className="p-2">
                    <i className="ph ph-spinner animate-spin text-2xl text-teal-500"></i>
                </div>
            );
        }
        ...
        return (
            <button
                ...
                className="p-2 rounded-full text-teal-600 dark:text-teal-400 hover:bg-teal-100 dark:hover:bg-gray-700"
                aria-label="تنزيل"
            >
         ...
         return (
             <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg">
                 <div className="p-4 border-b dark:border-gray-700 flex items-center">
                     ...
                     <div>
                        <h2 className="text-xl font-bold text-teal-800 dark:text-teal-400">اختر سورة من القارئ:</h2>
                        ...
                        return (
                         <li key={surah.number} className="flex items-center">
                             <button
                                 ...
                                 className={`flex-grow text-right p-4 transition-colors duration-200 flex justify-between items-center ${isActive ? 'bg-teal-100 dark:bg-teal-900/50 text-teal-800 dark:text-teal-300' : 'hover:bg-gray-100 dark:hover:bg-gray-700'}`}
                             >
    ...
    return (
        <div className="space-y-8">
            <div className="text-center">
                <h2 className="text-4xl font-bold text-teal-800 dark:text-teal-300">مشغل القرآن</h2>
                ...
                {qaris.map(qari => (
                    ...
                    >
                        <img 
                            src={qari.imageUrl} 
                            alt={qari.name} 
                            className="w-24 h-24 rounded-full object-cover mb-4 border-4 border-gray-100 dark:border-gray-700 group-hover:border-teal-300 dark:group-hover:border-teal-600 transition-all duration-300"
                        />

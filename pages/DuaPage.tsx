...
const DuaCard: React.FC<DuaCardProps> = ({ dua }) => (
    <div className="bg-white dark:bg-gray-800 p-5 rounded-xl shadow-md border-r-4 border-teal-500 mb-4">
        ...
        <p className="text-sm text-teal-600 dark:text-teal-400 font-mono">{dua.reference}</p>
    </div>
);
  ...
  return (
    <div className="border-b border-gray-200 dark:border-gray-700">
      <h2>
        <button
          type="button"
          className="flex items-center justify-between w-full p-5 font-medium text-right text-gray-700 dark:text-gray-300 hover:bg-teal-50 dark:hover:bg-gray-700/50 transition-colors"
          onClick={onClick}
          aria-expanded={isOpen}
        >
          <div className="flex items-center">
            <i className={`ph-fill ph-${category.icon} text-2xl text-teal-600 dark:text-teal-400 ml-4`}></i>
  ...
  return (
    <div className="bg-white dark:bg-gray-800/50 rounded-xl shadow-lg">
       <div className="text-center p-8 border-b border-gray-200 dark:border-gray-700">
        <h2 className="text-4xl font-bold text-teal-800 dark:text-teal-300">حصن المسلم</h2>

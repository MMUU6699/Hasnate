...
const QiblaPage: React.FC = () => {
  ...
  if (error) {
     return (
        <div className="flex flex-col items-center justify-center h-full text-center bg-white dark:bg-gray-800 rounded-xl p-8 shadow-lg">
            <i className="ph-fill ph-warning-circle text-6xl text-red-500 dark:text-red-400 mb-4"></i>
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full text-center p-4">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-6 sm:p-8 lg:p-12 w-full max-w-md relative">
        <h2 className="text-3xl font-bold text-teal-800 dark:text-teal-300 mb-2">اتجاه القبلة</h2>
        ...
        <div className="relative w-64 h-64 sm:w-80 sm:h-80 mx-auto">
          ...
          >
            {/* Compass markings */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 -mt-3 text-lg font-bold text-red-500">N</div>
            <div className="absolute bottom-0 left-1/2 -translate-x-1/2 -mb-3 text-lg font-bold">S</div>
            <div className="absolute top-1/2 right-0 -translate-y-1/2 -mr-3 text-lg font-bold">E</div>
            <div className="absolute top-1/2 left-0 -translate-y-1/2 -ml-3 text-lg font-bold">W</div>
            <div className="w-full h-full border-[10px] border-white dark:border-gray-800 rounded-full"></div>
          </div>
           ...
           {heading !== null ? (
               <div
                ...
                >
                    <div className="absolute top-[10%] left-1/2 -translate-x-1/2 w-0 h-0 
                        ...
                        border-b-[30px] border-b-teal-500">
                    </div>
                </div>
           ) : (
            ...
            {/* Center point */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-4 h-4 bg-teal-500 rounded-full border-2 border-white dark:border-gray-800"></div>
        </div>
